...
WIKI_PAGES = {
    ...
    "items": (
        ...
        "🔪 <b>Нож</b> (0.15%) — убивает чужого кеббита навсегда. "
        "Выпадает только если ни у кого нет ножа. "
        "Действует 6ч — если не использовать, исчезает (+🕊 Пацифист)\n"
    ...
    "achievements": (
        ...
        "🕊 <b>Пацифист</b> — не использовал нож (+1500 XP)"
    ),
    "referral": (
        "👥 <b>Рефералка</b>\n\n"
